...
Aber mit großer Macht geht auch große Verantwortung einher. Wenn man nur den Quellcode eines Projektes betrachtet, fehlen die generierten Dateien. Diese tauchen erst nach dem Kompilieren auf und auch dann kann man auf den ersten Blick nicht erkennen, woher die generierten Dateien kommen und wie sie erzeugt wurden.

Deshalb empfehlt es sich in der Projektdokumentation darauf hinzuweisen, dass Dateien beim kompilieren erzeugt werden und in den Kommentaren der generierten Dateien sollte man auf den Annotation Prozessor verweisen der sie erzeugt hat. Für Java-Quellcode gibt es zudem eine spezielle Annotation für generierte Klassen ([@Generated](https://docs.oracle.com/javase/7/docs/api/javax/annotation/Generated.html)), die man verwenden kann um auf dessen Herkunft zu verweisen.
